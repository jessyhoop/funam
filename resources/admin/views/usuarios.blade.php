...
//            var base_url = '<?php // echo base_url();     ?>';
    ...
    <body ng-app="app">
        ...
        <script src="{{asset('js/services/usuarios-service.js')}}" type="text/javascript"></script>
        <script src="{{asset('js/controllers/usuarios-controllers.js')}}" type="text/javascript"></script>
    </body>
</html>