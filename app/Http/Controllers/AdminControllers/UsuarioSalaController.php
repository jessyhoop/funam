...
use App\Models\UsuarioSala; //modelo
use Illuminate\Http\Request;
use App\Http\Controllers\ApiController;
use Illuminate\Validation\Rule;

class UsuarioSalaController extends ApiController {
...
//api---  http://localhost/funam/public/admin/carreras
        $usuariosSala = UsuarioSala::all();
//         if (!$usuariosSala) {
...
//            }else{
//           
//                print_r($usuariosSala);     
        return $this->showAll($usuariosSala);
//            }
    }
